...
class TestDatabase(unittest.TestCase):
    ...
    def test_tables_setup(self):
        ...
        self.assertGreaterEqual(result_list[0][1], 70)
    ...
    def test_queries(self):
        ...
        results = cur.execute(sql)
        result_list = results.fetchall()
        self.assertIn("November", result_list[0][2])
...
class TestUserInterface(unittest.TestCase):
    ...
    def test_tags_commands(self):
        ...
        self.assertEqual(data[1][0], "#letterpress #preservation #3dprinting #digitalhumanities #design #makerspace #bookhistory #libraries")

        data = process_tags(limit=15)
        self.assertEqual(data[0][0], 70)
        self.assertEqual(data[1][14], "U-M Bicentennial")
    ...
    def test_most_recent_commands(self):
        ...
        self.assertIn("CVGA Hours over the Holidays and between Semesters", list_of_recent_titles)
